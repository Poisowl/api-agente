...
class Settings:
    ...
    def __init__(self):
        ...
        self.PROJECT_NAME = os.getenv("PROJECT_NAME", "Agent Service")
        ...
        self.META_CREDENTIALS_KEY = os.getenv("META_CREDENTIALS_KEY")
        ...
        default_endpoints = {
            ...
            "login": ["5 per second", "100 per hour"],
            "bot": ["60 per minute"],
            "user": ["60 per minute"],
            "conversation": ["100 per minute"],
